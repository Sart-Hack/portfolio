            ...
            {experiences.map((exp, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full md:w-[44%] border ${colors.border} bg-white/10 rounded-xl p-7 transition-all duration-300 hover:bg-white/15 hover:border-white/15 hover:-translate-y-0.5`}>
